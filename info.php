...
<body>
  <div class="form">
    ...
    <h4>V 1.0.0 (08.05) - Uruchomienie aplikacji i udostępnienie pierwszej grupie</h4>
    <h4>V 0.5.0 (28.04) - Dodanie akcji i algorytmu kupna oraz sprzedaży</h4>
    <h4>V 0.4.0 (22.04) - Dodanie strony profilu użytkownika, systemu logowania, rejestracji i aktywacji</h4>
    <h4>V 0.3.0 (12.04) - Wersja Alpha grafiki dołączona</h4>
    <h4>V 0.2.0 (03.04) - Dodanie systemu logowania</h4>
    <h4>V 0.1.0 (02.04) - Uruchomienie serwera</h4>
  </div>
